...
form.onsubmit = function(e) {
    ...
    if (valid ){
        ...
        let whatsAppUrl = `https://wa.me/201234567890?text=${whatsAppMsg}`;
...
function typeEffect() {
    ...
    if (!deleting) {
        charIndex++;
        document.querySelector('.multiple-text').textContent = currentWord.substring(0, charIndex);
    }else{
        charIndex--;
        document.querySelector('.multiple-text').textContent = currentWord.substring(0, charIndex);
    }
...
//         document.documentElement.style.setProperty('--main-color', '#f8fafc')
//         document.documentElement.style.setProperty('--other-color', '#e2e8f0')
//         document.documentElement.style.setProperty('--second-color', '#2563eb')
//         document.documentElement.style.setProperty('--third-color', '#444')
//         document.documentElement.style.setProperty('--box-color', '#e2e8f0')
//         document.documentElement.style.setProperty('--server-color', '#1e293b4d')
//         document.documentElement.style.setProperty('--text-color', '#020617')
//         document.documentElement.style.setProperty('--white-50-color', 'rgba(0,0,0,0.5)')
...
//         document.documentElement.style.setProperty('--main-color', '#020617')
//         document.documentElement.style.setProperty('--other-color', '#0f172a')
//         document.documentElement.style.setProperty('--second-color', '#3b82f6')
//         document.documentElement.style.setProperty('--third-color', '#666')
//         document.documentElement.style.setProperty('--box-color', '#1e293b')
//         document.documentElement.style.setProperty('--server-color', '#1e293d')
//         document.documentElement.style.setProperty('--text-color', '#fff')
//         document.documentElement.style.setProperty('--white-50-color', 'rgba(255, 255, 255, 0.5)')
//         document.querySelector('.hero .landing .image').classList.remove('actiive');
//         document.querySelector('.footer').style.color = '#ccccccc7';
//     }
// }
